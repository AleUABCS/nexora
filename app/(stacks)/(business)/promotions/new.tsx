...
export default function NewPromotionView() {
  ...
  const createPromotion = async () => {
    ...
    try {
      ...
      Alert.alert("Éxito", "Promoción publicada correctamente");
      router.back();
    } catch (error) {
      Alert.alert("Error", "No se pudo publicar la promoción en este momento. Intenta de nuevo.");
    }
  };
            ...
            >
              <Text
                ...
                onPress={() =>
                  Alert.alert(
                    "Fichas",
                    "La cantidad de fichas necesarias indica cuántas veces el cliente tiene que validar la promoción para completarla y conseguirla"
                  )
                }
              >
                Fichas necesarias{" "}
